<template>
  <div class="container">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          "Us" or "Our" in this Agreement) refers to Notemanager.
        </p>
      </li>
      <li>
        <p><strong>"Country"</strong> refers to Turkiye.</p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>"Website"</strong> refers to Notemanager, accessible from
          notemanager.onur.iltan.com
        </p>
      </li>
      <li>
        <p>
    ...
    <p>
      ...
      Service if You post such objectionable Content.<br />
    ...
    <p>
      ...
      copyright agent via email ([onur.iltan@gmail.com]) and include in Your
    ...
    <p>
      You can contact our copyright agent via email ([onur.iltan@gmail.com]).
    ...
    <ul>
      <li>By sending us an email:[onur.iltan@gmail.com]</li>
    </ul>
    <p></p>
  </div>
</template>
